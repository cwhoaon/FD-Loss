#!/usr/bin/env bash
# Table 1c: single-backbone FD ablation on pMF-B/16 at 256px.
...
run_one() {
    ...
    torchrun \
        ...
        main_fd.py \
        --project table_1c_backbone_single \
        --exp_name "$exp_name" \
...
run_one pMF_B-fd-inception --fd_repr_models inception
run_one pMF_B-fd-convnext --fd_repr_models convnext
run_one pMF_B-fd-dinov2-cls --fd_repr_models vit_large_patch14_dinov2.lvd142m --fd_repr_pool_types cls
run_one pMF_B-fd-mae-cls --fd_repr_models vit_large_patch16_224.mae --fd_repr_pool_types cls --fd_target_sizes 224
run_one pMF_B-fd-siglip-cls --fd_repr_models vit_so400m_patch16_siglip_256.v2_webli --fd_repr_pool_types cls --fd_target_sizes 224
